"""
Load and Test CustomCNN Model on CIFAR-10
...
MODEL_PATH = MODEL_DIR / "CustomCNN_best.pth"
...
def load_model_weights(model, model_path, device):
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            f"예상 위치: CIFAR10_project/saved_models/CustomCNN_best.pth"
        )
