"""
Load and Test ResNet18 Scratch Model on CIFAR-10
...
def make_model(num_classes=10):
    ...
    # CIFAR-10용 ResNet 구조
    # 32x32 입력이므로 ImageNet용 7x7 conv, maxpool 대신 3x3 conv 사용
...
def load_model_weights(model, model_path, device):
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            f"예상 위치: CIFAR10_project/saved_models/ResNet18_best.pth"
        )
