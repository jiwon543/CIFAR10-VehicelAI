"""
Load and Test BasicNN_MLP Model on CIFAR-10
...
MODEL_PATH = MODEL_DIR / "BasicNN_MLP_best.pth"
...
def make_model_from_state_dict(state_dict):
...
def load_checkpoint(model_path, device):
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            f"예상 위치: CIFAR10_project/saved_models/BasicNN_MLP_best.pth"
        )
...
def main():
    ...
    model = make_model_from_state_dict(state_dict).to(device)
